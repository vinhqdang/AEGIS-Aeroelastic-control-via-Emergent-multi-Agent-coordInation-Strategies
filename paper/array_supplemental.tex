...
%% Flutter Suppression" (submitted to Array). Cited from the main text; not
%% subject to the journal's length guidance. Reproduces, unabridged,
%% material moved out of the main text to keep it a manageable length --
%% every finding stated here is covered by the same seed count and
%% statistical standard noted where it is used in the main text.
